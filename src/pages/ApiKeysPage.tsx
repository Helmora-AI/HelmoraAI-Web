...
export function ApiKeysPage() {
  ...
  function closeReceipt() { if (!acknowledged) return; setReceipt(undefined); setShowForm(false); setName(""); setScopes(["inference"]); setRestrictModels(false); setModelAllowlist([]); setModelSearch(""); setRpm(""); setTpm(""); }
